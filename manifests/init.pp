...
class solr (
  ...
  $install_postcommand = $solr::params::install_postcommand,
  $url_check           = $solr::params::url_check,
  $url_pattern         = $solr::params::url_pattern,
  $my_class            = "",
  $source              = "",
  $source_dir          = "",
  ...
  $puppi               = false,
  $debug               = false,
  $package             = $solr::params::package,   
  $config_dir          = $solr::params::config_dir,
  $config_file         = $solr::params::config_file,
  $config_file_mode    = $solr::params::config_file_mode,
  $config_file_owner   = $solr::params::config_file_owner,
  $config_file_group   = $solr::params::config_file_group,
  $data_dir            = $solr::params::data_dir, 
  $log_dir             = $solr::params::log_dir, 
  $log_file            = $solr::params::log_file 
